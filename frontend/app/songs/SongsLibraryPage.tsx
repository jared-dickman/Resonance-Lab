...
const LibraryTestIds = {
  container: 'songs-library',
...
export function SongsLibraryPage() {
  ...
  const [, setStatus] = useState<StatusMessage | null>(null);
  ...
  return (
    <div className="space-y-6" data-testid={LibraryTestIds.container}>
      <div className="space-y-2" data-testid={LibraryTestIds.songsList}>
        ...
        {!isLoading && songs.length === 0 && (
          ...
          >
            ...
            <p className="text-muted-foreground">
              No songs yet. Use Buddy to find and save songs.
            </p>
          </motion.div>
        )}
