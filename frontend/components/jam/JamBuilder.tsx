...
export default function JamBuilder({ progression, onUpdate, onClear }: JamBuilderProps) {
  ...
  const getChordInterval = (chord: JamChord) => {
  ...
  }, [isPlaying, currentChordIndex, progression.chords, bpm]);
              ...
              <CardTitle className="flex items-center justify-between">
                ...
                <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => setShowChordDisplay(false)}
                  >
                    <motion.div
        ...
        {!showChordDisplay && (
          ...
          >
            <Button
              variant="outline"
              className="w-full"
              onClick={() => setShowChordDisplay(true)}
            >
